...
#import "MyProductDetailsVC.h"
#import "Constants.h"

@implementation MyProductDetailsVC
...
- (void) prepareForm
{
    ...
    [codeTxt setText:[infoDict objectForKey:@"code"]];
    [priceTxt setText:[NSString stringWithFormat:@"%@",[infoDict objectForKey:@"price"]]];
    
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[infoDict objectForKey:@"image"]]]];
    
    detailsDict = [[NSMutableDictionary alloc] initWithDictionary:[infoDict objectForKey:@"details"]];
    [self loadTable];
}
