...
@implementation AskBannerQuestionVC
	...
	if ( [ text isEqualToString: @"\n" ] ) {
        ...
        if(VERSION == 2)
        {
            ...
            else
            {
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Type your question and Send" message:nil delegate:self cancelButtonTitle:@"Ok" otherButtonTitles: nil];
                [alert setTag:-1];
                [alert show];
                [alert release];
            }
...
- (void) sendMessage
{
	...
	NSURL *url = [[NSURL alloc] initWithString:[NSString stringWithFormat:@"%@/newBannerQuestion.php",URL]];
	...
	[req setPostValue:toid forKey:@"toid"];  // receiver's id
