...
- (void) loadData
{
    ...
    // myid - from constants MYID
    [req setPostValue:[NSString stringWithFormat:@"606"] forKey:@"id"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MyProductsVC *obj = [[MyProductsVC alloc] init];
